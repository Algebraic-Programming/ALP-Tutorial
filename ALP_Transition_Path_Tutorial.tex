...
\subsection{Installation (see Section \ref{sec:installation})}

Note: Before continuing, complete the installation and build steps described in Section \ref{sec:installation}. 
These steps ensure that ALP is properly compiled and it can be used as a library.
