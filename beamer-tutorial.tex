...
% convenience environment: \begin{cppcode} ... \end{cppcode}
\lstnewenvironment{cppcode}[1][]{\lstset{style=cpp-rich,#1}}{}
...
\subsection{7) Ising Machine}

\begin{frame}{Ising Machine}
\begin{itemize}
...
\subsection{8) other solvers}

\begin{frame}{new solvers}
\begin{itemize}
    \item New solver directions
\end{itemize}
% Owner: DJ
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Model-based optimization:} Predict performance before execution
        \item \textbf{Autotuning:} Automatically find optimal configurations and parameters
        \item \textbf{Algorithm reformulation:} Adapt/choose algorithms to fit hardware
        \item \textbf{HW-SW co-design:} Choose/evaluate/design hardware for specific algorithms
    \end{itemize}
    \item \textbf{Outcome:} Hardware-efficient algorithms $\leftrightarrow$ Software-aware hardware tuning
\end{itemize}
% Owner: PA
\end{frame}
