...
% ALgebraic Programming, or ALP for short, encompasses software technologies that allow
% programming with explicit algebraic structures combined with their automated parallelisation and optimisation.
% This document is a tutorial to the C++ interface to ALP distributed at \url{https://github.com/Algebraic-Programming/ALP}.
% ALP provides mechanisms by which auto-parallelisation of sequential, data-centric, and algebraic C++ programs proceeds...
\end{frame}

\subsection{2) Installation on Linux, demos}
\begin{frame}[fragile]{Installation on Linux (ALP)}
\begin{itemize}
  \item Prerequisites: compiler, OpenMP, CMake, NUMA, pthreads
  \item Clone, bootstrap, build, install
  \item Environment setup and grbcxx/grbrun
\end{itemize}
% Owner: TODO
% Source (ALP_Tutorial.tex - Installation on Linux):
% \section{Installation on Linux}\label{sec:installation}
% \begin{enumerate}
% \item \textbf{Install prerequisites} ... Debian/Ubuntu:
% \begin{verbatim}
% sudo apt-get install build-essential libnuma-dev libpthread-stubs0-dev cmake;
% \end{verbatim}
% \item \textbf{Obtain ALP} ... git clone https://github.com/Algebraic-Programming/ALP.git
% \item \textbf{Build ALP}
...
\end{itemize}
% Owner: TODO
% (Beamer draft had "BSP-based Performance Model"; integrate later.)
\end{frame}
